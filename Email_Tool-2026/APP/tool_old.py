...
def train_database():
    ...
    if has_file:
        ...
        status = process_single_file(
            file_path, output_files_path, old_db_pickle_file_path,
    ...
    summary = process_folder(
        folder_upload_dir, output_files_path, old_db_pickle_file_path,
        emit_fn=emit_train_log
    )
...
def upload_file():
    ...
    if file and file.filename != '':
        ...
        try:
            process_single_file(file_path, Output_files_path_old, old_db_pickle_file_path)
